...
public class HomeSwallow extends ZopostActivity implements SearchView.OnQueryTextListener,ICallBackFragmentToActivity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		this.setContentView(R.layout.activity_home_swallow);
		init_UI(this);
	}
	...
	private void init_UI(Activity activity) {
		...
		ft.replace(R.id.container, new Bee_Fragment_Home_Swallow());
	...
	private void getBalance() {
		...
		pd.show();
		ServiceManager.factoryData().getDataRaw("http://192.168.10.218:1234/", params, new ICallBackUI() {
	...
	public void onBackPressed() {
		...
		if (fragMain instanceof Bee_Fragment_Product_List) {
			...
			AlertDialog.Builder b = new AlertDialog.Builder(HomeSwallow.this);
