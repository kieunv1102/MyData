...
public class LoginSwallowActivity extends ZopostActivity
...
//				startActivity(t);
				 userLogin(LoginSwallowActivity.this);
			}
		});
		/* */
		// load data
		...
		if (ShareMemManager.getInstance().readFromDB(LoginSwallowActivity.this, "isRemember").equalsIgnoreCase("1")) {
			edtEmail.setText(ShareMemManager.getInstance().readFromDB(LoginSwallowActivity.this, "user"));
			edtPassWord.setText(ShareMemManager.getInstance().readFromDB(LoginSwallowActivity.this, "pass"));
...
//		edtPassWord.setText(ShareMemManager.getInstance().readFromDB(getApplicationContext(), "pass"));
	...
	private boolean userLogin(Activity activity, String... paramstInput) {
		...
		if (checkDataInput(userEmail, passWord)) {
			...
			// call to server
			pd = new ProgressDialog(LoginSwallowActivity.this);
				...
				if (status == 200) {
					...
					try {
						...
						if (oObject.getString("ResponseCode").equalsIgnoreCase("00")) {
							...
							ShareMemManager.getInstance().saveToDB(LoginSwallowActivity.this, "useroff", getEmail());
							ShareMemManager.getInstance().saveToDB(LoginSwallowActivity.this, "passoff", getPassWork());
							ShareMemManager.getInstance().saveToDB(LoginSwallowActivity.this, "username", getEmail());
							ShareMemManager.getInstance().saveToDB(LoginSwallowActivity.this, "password", getPassWork());
							if (cbRememberPassWord.isChecked()) {
								ShareMemManager.getInstance().saveToDB(LoginSwallowActivity.this, "isRemember", "1");
								// to remember password
								ShareMemManager.getInstance().saveToDB(LoginSwallowActivity.this, "user", getEmail());
								ShareMemManager.getInstance().saveToDB(LoginSwallowActivity.this, "pass", getPassWork());
								...
								// to remember password
								ShareMemManager.getInstance().saveToDB(LoginSwallowActivity.this, "isRemember", "0");
								ShareMemManager.getInstance().deleteFromDB(LoginSwallowActivity.this, "user");
								ShareMemManager.getInstance().deleteFromDB(LoginSwallowActivity.this, "pass");
							...
							formLodingData.setVisibility(View.GONE);
							//createMenu(ShareMemManager.getInstance().readFromDB(LoginSwallowActivity.this, "username"), ShareMemManager.getInstance().readFromDB(LoginSwallowActivity.this, "password"), json);
							LoadData();
	...
	private void showDialogConfirm() {
		// TODO Auto-generated method stub
		AlertDialog.Builder b = new AlertDialog.Builder(LoginSwallowActivity.this);
		...
		b.setPositiveButton("BÁN HÀNG", new DialogInterface.OnClickListener() {
			...
			public void onClick(DialogInterface dialog, int which) {
				...
				if (ShareMemManager.getInstance().readFromDB(LoginSwallowActivity.this, "useroff").equalsIgnoreCase(getEmail())
						&& ShareMemManager.getInstance().readFromDB(LoginSwallowActivity.this, "passoff")
