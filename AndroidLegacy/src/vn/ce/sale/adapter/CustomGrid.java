...
public class CustomGrid extends BaseAdapter {
	...
	public CustomGrid(Context c, List<JSONObject> d, int rowLineLayput) {
		mContext = c;
		dataSource = d;
		layoutRow = rowLineLayput;
	}

	public CustomGrid(Context c, List<JSONObject> d) {
		mContext = c;
		dataSource = d;
			...
			for (Integer i : bindRule.keySet()) {
				...
				if (o.getHandleClick() != null) {
					...
					if (o.isButon()) {
						...
						holder.editText.get(o.getIdUI()).setOnClickListener(o.getHandleClick());
					}
				}
				if (o.isEditText()) {
					if (o.watcher != null) {

						EditText gridEditText = holder.editText.get(o.getIdUI());
						gridEditText.setTag(position);
						o.watcher.setEditTextView(gridEditText);
						gridEditText.addTextChangedListener(o.watcher);
					}
					if (o.getOnFocusChange() != null) {
						holder.editText.get(o.getIdUI()).setOnFocusChangeListener(o.getOnFocusChange());
					}
				}
				if (o.isText()) {
