...
public class ProductGridNoEdit extends BaseAdapter {
	...
	public ProductGridNoEdit(Context c, List<JSONObject> d) {
		mContext = c;
		dataSource = d;
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		try {
			...
			if (convertView == null) {
				...
				//
				if (layoutRow == -1)
					grid = inflater.inflate(R.layout.layout_customer_list_row2_noedit, null);
				else
			...
			holder.txtTensp.setText(
					"L: " + "_" + lineSource.getString("ProductCode") + "." + lineSource.getString("ProductName"));
			...
			if (lineSource.getString("IsLot").equalsIgnoreCase("true")) {
				// holder.chkKM.setVisibility(View.GONE);
