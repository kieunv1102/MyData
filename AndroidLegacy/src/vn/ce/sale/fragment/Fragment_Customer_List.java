...
public class Fragment_Customer_List extends ZopostFragment implements ICallBackActivityToFragment, ICallBackUI {
	...
	protected void startLoadData() {
		...
		ServiceManager.factoryData().getDataRaw(
				Util.SERVER_URL + "/agency.aspx?type=get&memberid=" + Util.memberid + "&",
