...
public class Bee_Fragment_Vas_Prepay_Bank extends ZopostFragment implements ICallBackUI {
	...
	public static Bee_Fragment_Vas_Prepay_Bank newInstance(String aa) {
		Bee_Fragment_Vas_Prepay_Bank fragment = new Bee_Fragment_Vas_Prepay_Bank();
	...
	public View onCreateView(final LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		rootView = inflater.inflate(R.layout.bee_fragment_vas_prepay_bank, container, false);
		browser = (WebView) rootView.findViewById(R.id.webBankPrepay);
	...
	private void startWebView(String url) {
		...
		browser.setWebViewClient(new WebViewClient() {
			...
			public void onLoadResource(WebView view, String url) {
				...
				if (parts[0].equals("http://192.168.10.214:1234/ReceiveResult/Payment/?t=keypay")) {
					progressDialog.show();
				}
