...
public class Fragment_OrderPurchase_ListStatus1_Online extends ZopostFragment
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		Util.saveActionUser(getActivity(), "DS-DON-ORDER-OFF", (new Date()).getTime());
	...
	protected void startLoadData() {
		...
		String paramString = "data={\"ActionType\":\"REPORT_ORDER\",\"UserName\":\""
				...
				+ (page - 1) * totalRecord + ",\"Size\":" + totalRecord + ",\"Status\":" + params.getString("status")
				+ "}";
		// TODO Auto-generated method stub
				...
				if (status == 200) {
					...
					if (adapter == null) {
						...
						adapter = new CustomGridAndFilter(getActivity(), lstJsonObjects,
								R.layout.layout_order_list_row_online, new String[] { "OrderCode" });
						...
						adapter.bindFields(new BindDataUI[] { BindDataUI.createNew(R.id.customer_madonhang, "server",
								...
								, BindDataUI.createNew(R.id.customer_tongtien, "server", TypeUI.COMPLEX, null,
									...
									public String parseFromSource(JSONObject o, BindDataUI ui) {
										...
										try {
											return "Trạng thái: " + o.getString("StatusText");
											// String date =
						...
						grid.setOnItemClickListener(new AdapterView.OnItemClickListener() {
							...
							public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
								Util.checkPage2 = true;
								try {
									nextToFragment(new FragmentOrderCreate_ViewOrConfirm(),
											BundleData.createNew().putString("screen", Util.SCREEN_ORDER_CREATE_VIEW)
	...
	JSONObject convertToOfflineJSON(JSONObject oNeedToConvert) throws JSONException {
		...
		oResult.put("status", oNeedToConvert.getInt("Status"));
		oResult.put("OrderCode", oNeedToConvert.getString("OrderCode"));
		oResult.put("StatusText", oNeedToConvert.getString("StatusText"));
		...
		for (int jx = 0; jx <= arrProduct.length() - 1; jx++) {
			 ...
			 * oProductInOder.put("KM", "1"); oProductInOder.put("TT", "0");
			 * //price = (int) (oProduct.getInt("TotalProducValue") /
			 * oProduct.getInt("Quantity")); oProductInOder.put("Price", price);
			...
			if (oProduct.getInt("DetailType") == 1) {
				...
				price = (int) (oProduct.getInt("TotalProducValue") / oProduct.getInt("Quantity"));
				oProductInOder.put("Price", oProduct.getInt("ProducValue"));
				oOrderItems.put(oProductInOder);
			}
		...
		oResult.put("tongtien", oNeedToConvert.getString("TotalPrice"));
		return oResult;
	}
