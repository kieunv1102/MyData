...
public class Fragment_Order_Create_ListTabViewer extends ZopostFragment
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		View rootView = inflater.inflate(R.layout.vi21_fragment_order_create_list_tabs_viewer, container, false);
		...
		Util.saveActionUser(getActivity(), "DS-DON-ORDER", (new Date()).getTime());
		// setUpTabColor();
		// mViewPager.setAdapter(mDemoCollectionPagerAdapter);
	...
	public class DemoCollectionPagerAdapter extends FragmentStatePagerAdapter {
		...
		public Fragment getItem(int i) {
			if (i == 0) {
				...
				Fragment fragment = new Fragment_OrderPurchase_ListStatus1_Online();
				...
				Bundle args = new Bundle();
				// Our object is just an integer :-P
				args.putString("status", String.valueOf(-1));
				fragment.setArguments(args);
				registeredFragments.put(i, fragment);
				return fragment;
			}
