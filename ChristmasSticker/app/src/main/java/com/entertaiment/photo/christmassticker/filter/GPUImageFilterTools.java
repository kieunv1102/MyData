package com.entertaiment.photo.christmassticker.filter;
...
public class GPUImageFilterTools {
    public static ArrayList<FilterType> initFilter() {
        ArrayList<FilterType> arrFilter = new ArrayList<>();
        arrFilter.add(FilterType.CONTRAST);
        arrFilter.add(FilterType.INVERT);
        arrFilter.add(FilterType.PIXELATION);
        arrFilter.add(FilterType.HUE);
        arrFilter.add(FilterType.GAMMA);
        arrFilter.add(FilterType.SEPIA);
        arrFilter.add(FilterType.GRAYSCALE);
        arrFilter.add(FilterType.SHARPEN);
        arrFilter.add(FilterType.SOBEL_EDGE_DETECTION);
        arrFilter.add(FilterType.THREE_X_THREE_CONVOLUTION);
        arrFilter.add(FilterType.EMBOSS);
        arrFilter.add(FilterType.POSTERIZE);
        arrFilter.add(FilterType.FILTER_GROUP);
        arrFilter.add(FilterType.SATURATION);
        arrFilter.add(FilterType.EXPOSURE);
        arrFilter.add(FilterType.HIGHLIGHT_SHADOW);
        arrFilter.add(FilterType.MONOCHROME);
        arrFilter.add(FilterType.VIGNETTE);
        arrFilter.add(FilterType.BLEND_DISSOLVE);
        arrFilter.add(FilterType.BLEND_OVERLAY);
        arrFilter.add(FilterType.BLEND_SCREEN);
        arrFilter.add(FilterType.BLEND_HUE);
        arrFilter.add(FilterType.BLEND_SATURATION);
        arrFilter.add(FilterType.BLEND_SOFT_LIGHT);
        arrFilter.add(FilterType.BLEND_CHROMA_KEY);
        arrFilter.add(FilterType.CROSSHATCH);
        arrFilter.add(FilterType.BOX_BLUR);
        arrFilter.add(FilterType.CGA_COLORSPACE);
        arrFilter.add(FilterType.DILATION);
        arrFilter.add(FilterType.KUWAHARA);
        arrFilter.add(FilterType.RGB_DILATION);
        arrFilter.add(FilterType.SKETCH);
        arrFilter.add(FilterType.TOON);
        arrFilter.add(FilterType.SMOOTH_TOON);
        arrFilter.add(FilterType.BULGE_DISTORTION);
        arrFilter.add(FilterType.GLASS_SPHERE);
        arrFilter.add(FilterType.HAZE);
        arrFilter.add(FilterType.LAPLACIAN);
        arrFilter.add(FilterType.NON_MAXIMUM_SUPPRESSION);
        arrFilter.add(FilterType.SPHERE_REFRACTION);
        arrFilter.add(FilterType.SWIRL);
        arrFilter.add(FilterType.WEAK_PIXEL_INCLUSION);
        arrFilter.add(FilterType.FALSE_COLOR);
        arrFilter.add(FilterType.COLOR_BALANCE);
        arrFilter.add(FilterType.LEVELS_FILTER_MIN);
        return arrFilter;
    }
